    ...
    >
      <div className="flex items-center gap-4 mb-16">
        <h3 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white">
          Experience<span className="text-teal-600 dark:text-sky-500">.log</span>
        </h3>
        <div className="h-[1px] flex-grow bg-gradient-to-r from-teal-500/30 to-transparent dark:from-sky-500/30" />
      </div>

      <div className="relative space-y-8">
        <div
          className="absolute left-[11px] md:left-6 top-2 bottom-2 w-[1px]
          bg-gradient-to-b from-teal-500 via-blue-500/20 to-transparent
          dark:from-sky-500 dark:via-blue-500/20"
        />
        ...
        {experiences.map((experience, idx) => (
          ...
          >
            <div className="absolute left-0 md:left-4 top-1 w-6 h-6 flex items-center justify-center">
              <div className="absolute inset-0 rounded-full animate-ping bg-teal-500/20 dark:bg-sky-500/20" />
              <div
                className="relative w-3 h-3 rounded-full z-10 border-2
                bg-white border-teal-500 dark:bg-[#0a0a0f] dark:border-sky-500"
              />
            </div>

            <div
              className="p-6 md:p-8 rounded-[2rem] transition-all duration-500 backdrop-blur-sm
              bg-white/80 border border-slate-200 shadow-sm hover:shadow-md hover:border-teal-500/30
              dark:bg-white/5 dark:border-white/5 dark:hover:border-sky-500/20 dark:shadow-none dark:group-hover:bg-white/[0.07]"
            >
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 mt-2 text-sm font-mono text-slate-500 dark:text-gray-500">
                    <span className="flex items-center gap-1.5">
                      <Briefcase size={14} className="text-teal-500 dark:text-sky-500" /> {experience.company}
                    </span>
                    <span className="flex items-center gap-1.5">
              ...
              <div className="flex flex-wrap gap-2 pt-4 border-t border-slate-100 dark:border-white/5">
                {experience.highlights.map((tech) => (
                  <span
                    ...
                    bg-slate-50 border border-slate-200 text-slate-500 group-hover:border-teal-500/30
                    dark:bg-white/5 dark:border-white/5 dark:text-gray-400 dark:group-hover:border-sky-500/20"
                  >
                    <CheckCircle2 size={10} className="text-teal-500/50 dark:text-sky-500/50" />
                    {tech}
                  </span>
                ))}
              </div>
