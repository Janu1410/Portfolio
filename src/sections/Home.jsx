...
const Home = () => {
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-4xl flex items-center justify-center">
        <div className="w-full text-center">
          <div className="mb-4 md:mb-5 inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[9px] sm:text-[11px] md:text-xs font-semibold uppercase tracking-[0.22em] mx-auto
          ...
          <div className="text-[15px] sm:text-lg md:text-2xl lg:text-3xl font-medium text-slate-600 dark:text-gray-400 mb-5 md:mb-6 flex flex-col md:flex-row items-center justify-center gap-2">
            <span>I am a</span>
          ...
          <motion.p
            ...
            className="max-w-2xl text-[13px] sm:text-[15px] md:text-lg text-slate-600 dark:text-gray-400 mb-6 md:mb-8 leading-relaxed mx-auto"
          >
