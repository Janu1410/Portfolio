...
const experience = {
  ...
  description:
    'KCX is a FinOps-focused startup building cloud cost intelligence solutions. I contribute to dashboard development, data-ingestion workflows, and platform-level performance improvements.',
  ...
  return (
    ...
    >
      ...
      <div className="mt-16 flex justify-center">
        ...
        >
          <Terminal size={12} />
          <span className="uppercase tracking-[0.2em]">Current internship record active</span>
        </div>
      </div>
    </motion.section>
  );
